...
export const Info = Schema.Struct({
  ...
  explain_before_edit: Schema.optional(Schema.Boolean).annotate({
    description:
      "Require a valid explanation and fresh approval for each edit proposal. Defaults to false. Does not cover arbitrary shell or plugin filesystem changes.",
  }),
